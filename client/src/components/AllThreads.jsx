...
function AllThreads() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-32 min-h-[60vh]">
        ...
        <div className="mt-6 text-lg text-white/80 font-semibold">Loading threads...</div>
      </div>
    );
  }
  ...
  return (
    <div className="relative px-1 py-4 md:py-7 md:pb-32 bg-transparent min-h-full max-w-full overflow-x-hidden select-none">
      {/* Header */}
                    <div className="flex justify-between items-center mb-8 flex-wrap">
                      <div>
                        ...
                        <p className="text-white/70 mt-2">write your thoughts and experiences</p>
                      </div>
                      <Link
                        to="/add-thread"
      ...
      {posts.length === 0 ? (
        <p className="text-lg text-white/60">No threads available</p>
      ) : (
              ...
              .map((post, idx) => {
                ...
                return (
                  <motion.div
                    key={post._id}
                    layout
                    className="relative card bg-black/30 ring-1 ring-inset ring-white/10 backdrop-blur-lg shadow-2xl rounded-2xl p-6 md:p-9 transition-transform duration-300 hover:scale-[1.012] hover:shadow-[0_6px_40px_0_rgba(255,118,36,0.11)] w-full max-w-3xl mx-auto"
                  ...
                  >
                    ...
                    <button
                      ...
                      aria-label={`Go to ${post.author?.name || 'User'} profile`}
                    >
                      <img
                        src={
                    ...
                    <div className="flex gap-3 md:gap-5 mt-2 flex-wrap">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        aria-label={userUpvoted ? "Remove upvote" : "Add upvote"}
                        disabled={loading}
                      >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        aria-label={userDownvoted ? "Remove downvote" : "Add downvote"}
                        disabled={loading}
                      >
