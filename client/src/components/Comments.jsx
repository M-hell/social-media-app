  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex justify-center items-center">
      <div className="relative w-4/5 max-w-2xl">
        ...
        {/* Comments container with reduced max height */}
        <div className="bg-gray-800 p-6 rounded-md shadow-md w-full max-h-[60vh] flex flex-col text-white">
          <h2 className="text-2xl font-bold mb-4">Comments</h2>

          {/* Render previous comments */}
          <div className="mb-4 max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600">
            {comments.length > 0 ? (
