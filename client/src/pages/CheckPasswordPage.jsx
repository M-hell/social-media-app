      ...
      <AnimatePresence>
        ...
        >
          ...
          <div className="w-fit mx-auto mb-2 flex justify-center items-center flex-col">
            ...
            />
            <h2 className="font-bold text-2xl mt-3 bg-clip-text text-transparent bg-gradient-to-r from-white via-white/80 to-yellow-300/90 text-center tracking-tight select-none">
              {location?.state?.name}
            </h2>
          </div>
          ...
          <form className="flex flex-col gap-6 mt-2" onSubmit={handleSubmit} autoComplete="off">
            <div className="flex flex-col gap-1.5 relative">
              <label htmlFor="password" className="pl-1 text-white/70 font-medium mb-[2px] text-sm flex items-center gap-1">
                <HiOutlineLockClosed className="inline align-middle text-white/60" aria-hidden />
                Password
              </label>
            ...
            <motion.button
              type="submit"
              className="relative bg-gradient-to-r from-orange-500/80 to-purple-500/80 hover:from-orange-400 hover:to-purple-400 via-pink-600/80 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary/50 px-4 py-3 rounded-xl font-bold text-white text-lg shadow-md active:scale-98 disabled:opacity-60 flex items-center justify-center select-none mt-2"
              style={{
